let nama = "Ndie Muhammad sudah belajar github"; //string
...
alert(
  `saldo awal saya sebesar Rp.${saldoAwal} & saldo tambahan yang akan saya miliki sebesar Rp.${saldoTambahan} jadi total saldo saya sebesar Rp.${saldoAkhir}`
);
